...
{/* 
      ...
      <div className='title_title'>
        A Full-Stack Developer Based in San Francisco, USA
      </div>
      <div className='title_skills'>
        React • Node.js • Express • Material-UI • Jest • Redux •
        Vue.js • Django • MongoDB • PostgreSQL • SQLite • Restful •
        Git • Linux • AWS EC2 • HTML • CSS
      </div>
